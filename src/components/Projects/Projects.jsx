...
const Projects = () => {
  return (
    <section id="projects" className="px-4 py-16 md:px-12">
      <div className="container relative mx-auto text-center">
        ...
        <div className="flex flex-wrap justify-center gap-6">
          ...
          >
            <button className="w-full bg-[var(--primary)] text-white text-body py-3 px-8 rounded-4xl hover:bg-[var(--secondary)] transition duration-300 font-helvetica flex items-center justify-center text-center">
