...
const AboutPage = () => {
  return (
    <section id="about" className="px-4 py-20 bg-white md:px-12">
      <div className="max-w-6xl mx-auto">
        ...
        {/* Grid layout: Text + Highlight box */}
        <div className="grid items-start gap-12 md:grid-cols-2">
          {/* Text */}
          <div className="text-body font-helvetica text-[var(--text-primary)] leading-[1.7]">
            <p className="mb-5">
              Hello! I’m a frontend developer with a strong interest in 3D design
              and interactive web experiences.
            </p>

            <p className="mb-5">
              I enjoy building visually engaging, user-friendly interfaces using
              technologies like HTML, CSS, JavaScript, and React.
            </p>

            <p>
              I’m always exploring new tools and techniques to push the
              boundaries of modern web design.
            </p>
          </div>
          ...
          >
            <ul className="space-y-4 text-[var(--text-primary)]">
              <li>
                <span className="font-medium">Location:</span> Norway
              </li>
              <li>
                <span className="font-medium">Focus:</span> Frontend & 3D
              </li>
              <li>
