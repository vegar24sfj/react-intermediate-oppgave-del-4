...
const Hero = ({ scrollToSection }) => {
  ...
  return (
    <section className="relative w-full h-[60vh] sm:h-[70vh] flex items-center justify-center bg-[var(--bg-primary)] mt-[var(--header-height)] px-4">
      <div className="text-center sm:px-8">
        <h1 className="text-5xl sm:text-6xl lg:text-7xl font-extrabold text-[var(--text-primary)] mb-4 sm:mb-6 tracking-tight">
